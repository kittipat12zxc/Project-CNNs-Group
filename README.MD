...
## Preparation
ส่วนเตรียมข้อมูล(แต่ละคน)[![1.	Dataset ที่ใช้
...
](<Screenshot 2025-08-13 165050.png>)]
...
[![alt text](<Screenshot 2025-08-12 082653.png>)]
[![alt text](<Screenshot 2025-08-12 082824.png>)]
[![alt text](<Screenshot 2025-08-12 083049.png>)]

## Model-test
ส่วนของโมเดล(แต่ละคน) 
ใช้โมเดลสำเร็จรูปจาก torchvision resnet18_torchvision.py :
